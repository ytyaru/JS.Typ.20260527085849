...
//                [C,'r.ins(C)'],
        ...
        describe('Typ.of', ()=>{
            ...
            test.each([
                ...
                [new A(),a=>a.r.ins], // Arrayは継承してもArray(ObjectでもInstance<A>でもない)
                [new A(),a=>a.r.ins(A)], // Arrayは継承してもArray(ObjectでもInstance<A>でもない)
                [[], a=>a.r.obj],
                [[], a=>a.r.ins],
        ...
        /*
        describe('ConTyp', ()=>{
            test.each([[NaN,NaN]])('(%p)->T', (v,C)=>expect(Typ.of(v,C)).toBe(true));
        });
        */
    });
