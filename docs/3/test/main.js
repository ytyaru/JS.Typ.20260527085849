    ...
    describe('IT', ()=>{
        ...
        describe('Typ.id', ()=>{
            test.each([
                ...
                ...[[],new (class A extends Array{})()].map(v=>[v,'r.ary']),
                [{}, 'r.obj'],
                ...
                [new (class A extends Array{})(),'r.ary'],
                [Object.create({}),'r.ins'], // r.objでない。Instance<Object>
                [new (class O extends Object{})(),'r.ins'], // r.objでない。Instance<O>
                [new (class C{})(),'r.ins'],
                [new Date(),'r.ins'],
                [class C{}, 'r.cls'],
        ...
        describe('Typ.throw', ()=>{
            ...
            test('(c,a=>a.r.obj)->E',()=>terr(()=>Typ.throw(c,a=>a.r.obj),TypeError,`値が期待する型と違います。期待:r.obj, 実際:r.ins`));
        });
    });
});
